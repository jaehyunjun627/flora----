...
public class ForestApiService {
    ...
    static {
        ...
        String[][] data = {
            ...
            {"국화",       "Chrysanthemum morifolium",    "국화과",       "국화목",       "chrysanthemum",     "정명", "가을을 대표하는 꽃으로 다양한 꽃잎 형태와 색상을 가진다. 차, 약재, 관상용으로 널리 이용된다.", "정원, 화단", "없음"},
            {"진달래",     "Rhododendron mucronulatum",   "진달래과",     "진달래목",     "Korean azalea",     "정명", "한국 산야에 자생하는 낙엽관목으로 이른 봄 잎보다 먼저 분홍색 꽃이 핀다. 꽃잎은 식용 가능하여 화전을 만든다.", "산지, 숲 가장자리", "없음"},
            {"개나리",     "Forsythia koreana",           "물푸레나무과", "물푸레나무목", "Korean forsythia",  "정명", "한국 특산 식물로 이른 봄 노란색 꽃이 가지에 가득 핀다. 한국의 봄을 알리는 대표적인 꽃나무이다.", "산기슭, 정원, 공원", "없음"},
            {"벚나무",     "Prunus serrulata",            "장미과",       "장미목",       "cherry blossom",    "정명", "봄에 화려한 분홍색 또는 흰색 꽃이 피는 낙엽교목이다. 꽃이 만개할 때 꽃비가 내리는 풍경이 장관이다.", "산지, 공원, 가로수", "있음 (씨앗·잎에 시안화물 포함)"},
            {"라벤더",     "Lavandula angustifolia",      "꿀풀과",       "꿀풀목",       "lavender",          "정명", "보라색 꽃과 강한 향기가 특징인 허브 식물이다. 아로마테라피, 향수, 차 등에 널리 사용된다.", "지중해 기후, 정원", "없음"},
            {"해바라기",   "Helianthus annuus",           "국화과",       "국화목",       "sunflower",         "정명", "태양을 향해 꽃대가 움직이는 큰 노란 꽃이 특징인 한해살이풀이다. 씨앗은 식용유와 간식으로 이용된다.", "밭, 정원, 공원", "없음"},
            {"연꽃",       "Nelumbo nucifera",            "연꽃과",       "프로테아목",   "lotus flower",      "정명", "수생 식물로 진흙에서 자라면서도 아름다운 꽃을 피운다. 불교에서 청정함의 상징으로 여겨진다.", "연못, 저수지, 습지", "없음"},
            {"민들레",     "Taraxacum officinale",        "국화과",       "국화목",       "dandelion",         "정명", "노란 꽃이 진 뒤 하얀 솜털 같은 씨앗이 바람에 날린다. 잎은 나물로, 뿌리는 차나 약재로 이용된다.", "들판, 길가, 초원", "없음"},
            {"무궁화",     "Hibiscus syriacus",           "아욱과",       "아욱목",       "rose of sharon",    "정명", "대한민국의 국화로, 여름부터 가을까지 끊임없이 꽃이 핀다. 이름처럼 영원히 피고 지지 않는 꽃이라는 뜻이다.", "정원, 공원, 울타리", "없음"},
            {"은행나무",   "Ginkgo biloba",               "은행나무과",   "은행나무목",   "ginkgo tree",       "정명", "살아있는 화석이라 불리는 세계에서 가장 오래된 나무 중 하나이다. 가을에 노란 부채꼴 잎이 장관을 이룬다.", "가로수, 공원, 사찰", "있음 (열매 과육 접촉 시 피부염, 과다 섭취 시 중독)"},
            {"수선화",     "Narcissus tazetta",           "수선화과",     "비짜루목",     "narcissus",         "정명", "이른 봄 향기로운 흰색 또는 노란색 꽃이 피는 구근식물이다. 수선(水仙)이란 물가의 신선이라는 뜻이다.", "정원, 화단, 화분", "있음 (전초에 리코린 함유, 구근 섭취 시 위험)"},
            {"카네이션",   "Dianthus caryophyllus",       "석죽과",       "석죽목",       "carnation",         "정명", "어버이날을 상징하는 꽃으로, 감사와 사랑의 의미를 담고 있다. 다양한 색상의 겹꽃이 특징이다.", "정원, 온실, 화분", "없음"},
            {"백합",       "Lilium longiflorum",          "백합과",       "백합목",       "lily flower",       "정명", "우아한 나팔 모양의 흰 꽃이 피며, 강한 향기가 특징이다. 순결과 순수의 상징으로 여겨진다.", "정원, 화단, 온실", "있음 (고양이에게 매우 유독, 사람은 경미)"},
            {"목련",       "Magnolia kobus",              "목련과",       "목련목",       "magnolia",          "정명", "봄 잎이 나기 전 크고 흰 꽃이 가지 끝에 핀다. 향기가 좋아 정원수로 인기가 많다.", "산지, 정원, 공원", "없음"},
            {"철쭉",       "Rhododendron schlippenbachii", "진달래과",    "진달래목",     "royal azalea",      "정명", "진달래와 비슷하지만 꽃이 더 크고 잎과 함께 핀다. 봄 산을 분홍빛으로 물들이는 아름다운 꽃이다.", "산지, 정원", "있음 (꽃과 잎에 그레이아노톡신 함유)"},
            {"동백나무",   "Camellia japonica",           "차나무과",     "차나무목",     "camellia",          "정명", "겨울부터 이른 봄에 빨간 꽃이 피는 상록 교목이다. 꽃이 질 때 꽃잎이 하나씩 떨어지지 않고 통째로 떨어진다.", "남부지방, 섬, 해안", "없음"},
            {"매화",       "Prunus mume",                 "장미과",       "장미목",       "plum blossom",      "정명", "이른 봄 추위 속에서 가장 먼저 꽃을 피워 선비의 절개를 상징한다. 매실 열매는 건강식품으로 이용된다.", "산기슭, 정원, 과수원", "있음 (덜 익은 열매에 청산배당체 함유)"},
            {"작약",       "Paeonia lactiflora",          "작약과",       "범의귀목",     "peony",             "정명", "크고 풍성한 꽃이 특징으로 함박꽃이라고도 불린다. 뿌리는 한방 약재로 사용된다.", "정원, 화단, 약초밭", "없음"},
            {"코스모스",   "Cosmos bipinnatus",           "국화과",       "국화목",       "cosmos flower",     "정명", "가을 들판을 수놓는 대표적인 꽃으로 분홍, 흰색, 자주색 꽃이 핀다. 가느다란 줄기가 바람에 흔들리는 모습이 아름답다.", "들판, 도로변, 공원", "없음"},
            {"수국",       "Hydrangea macrophylla",       "수국과",       "층층나무목",   "hydrangea",         "정명", "토양 산도에 따라 꽃 색이 파란색 또는 분홍색으로 변하는 신기한 식물이다. 여름에 풍성한 꽃송이가 핀다.", "정원, 화단, 공원", "있음 (잎과 꽃에 시안배당체 함유)"},
            {"봉선화",     "Impatiens balsamina",         "봉선화과",     "진달래목",     "balsam flower",     "정명", "여름에 빨간 꽃이 피며, 꽃잎으로 손톱을 물들이는 전통이 있다. 익은 열매를 건드리면 씨가 튀어나온다.", "정원, 화단, 화분", "없음"},
            {"나팔꽃",     "Ipomoea nil",                 "메꽃과",       "가지목",       "morning glory",     "정명", "아침에 피었다가 오후에 시드는 덩굴식물이다. 파란색, 분홍색, 보라색 나팔 모양 꽃이 특징이다.", "울타리, 정원, 화분", "있음 (씨앗에 리세르그산 아미드 함유)"},
            {"패랭이꽃",   "Dianthus chinensis",          "석죽과",       "석죽목",       "Chinese pink",      "정명", "분홍색 또는 붉은색의 작은 꽃이 군락으로 피어 화단을 수놓는다. 꽃잎 가장자리에 톱니 모양이 있다.", "산지, 초원, 화단", "없음"},
            {"수련",       "Nymphaea tetragona",          "수련과",       "수련목",       "water lily",        "정명", "수면 위에 떠서 피는 아름다운 수생 식물이다. 연꽃과 달리 잎과 꽃이 수면에 붙어 있다.", "연못, 저수지, 수조", "없음"},
            {"제비꽃",     "Viola mandshurica",           "제비꽃과",     "말피기목",     "violet flower",     "정명", "봄에 보라색 작은 꽃이 피는 여러해살이풀이다. 제비가 돌아올 때 피어서 제비꽃이라 불린다.", "산야, 길가, 풀밭", "없음"},
            {"칸나",       "Canna indica",                "칸나과",       "생강목",       "canna lily",        "정명", "여름부터 가을까지 빨강, 노랑, 주황의 크고 화려한 꽃이 피는 열대 식물이다.", "화단, 공원, 정원", "없음"},
            {"백일홍",     "Zinnia elegans",              "국화과",       "국화목",       "zinnia flower",     "정명", "이름처럼 오랫동안 꽃이 피어 백일 동안 붉다는 뜻이다. 다양한 색상의 꽃이 여름 정원을 밝힌다.", "정원, 화단, 공원", "없음"},
            {"금잔화",     "Calendula officinalis",       "국화과",       "국화목",       "marigold",          "정명", "주황색 또는 노란색 꽃이 피며, 식용과 약용으로 모두 사용된다. 피부 진정 효과가 있어 화장품에도 쓰인다.", "정원, 화단, 약초밭", "없음"},
            {"아이리스",   "Iris ensata",                 "붓꽃과",       "비짜루목",     "iris flower",       "정명", "붓꽃이라고도 불리며, 보라색 또는 흰색의 우아한 꽃이 특징이다. 습지나 물가에서 잘 자란다.", "습지, 연못 가장자리", "있음 (뿌리줄기에 이리딘 함유)"},
            {"프리지아",   "Freesia refracta",            "붓꽃과",       "비짜루목",     "freesia flower",    "정명", "달콤한 향기와 밝은 색상의 깔때기 모양 꽃이 특징이다. 절화와 향수 원료로 인기가 높다.", "온실, 화분, 정원", "없음"},
            {"안개꽃",     "Gypsophila paniculata",       "석죽과",       "석죽목",       "baby breath flower","정명", "작은 흰 꽃이 안개처럼 무수히 피어 꽃다발의 대표적인 부자재로 사용된다.", "정원, 화단, 온실", "없음"},
            {"클레마티스", "Clematis patens",             "미나리아재비과","미나리아재비목","clematis flower",   "정명", "덩굴을 타고 올라가며 크고 화려한 꽃이 피는 식물이다. 으아리라고도 불린다.", "정원, 울타리, 파고라", "있음 (프로토아네모닌 함유, 피부 자극)"},
            {"데이지",     "Bellis perennis",             "국화과",       "국화목",       "daisy flower",      "정명", "순수함을 상징하는 작고 사랑스러운 꽃이다. 흰 꽃잎과 노란 중심이 태양을 닮았다.", "정원, 화단, 잔디밭", "없음"},
            {"달리아",     "Dahlia pinnata",              "국화과",       "국화목",       "dahlia flower",     "정명", "크고 화려한 꽃이 피며, 색상과 형태가 매우 다양하다. 멕시코의 국화이기도 하다.", "정원, 화단", "없음"},
            {"허브제라늄", "Pelargonium graveolens",      "쥐손이풀과",   "쥐손이풀목",   "geranium flower",   "정명", "독특한 향이 나는 잎과 분홍색 꽃이 특징이다. 모기를 쫓는 효과가 있어 허브로 인기가 많다.", "화분, 베란다, 정원", "없음"},
            {"자스민",     "Jasminum officinale",         "물푸레나무과", "물푸레나무목", "jasmine flower",    "정명", "달콤하고 진한 향기가 나는 흰색 꽃이 특징이다. 자스민 차의 원료로도 유명하다.", "정원, 울타리, 화분", "없음"},
            {"란타나",     "Lantana camara",              "마편초과",     "꿀풀목",       "lantana flower",    "정명", "작은 꽃이 둥글게 모여 피며, 시간이 지남에 따라 색이 변하는 신기한 식물이다.", "정원, 화분, 지피식물", "있음 (덜 익은 열매 섭취 시 간 독성)"},
            {"스타티스",   "Limonium sinuatum",           "갯질경이과",   "석죽목",       "statice flower",    "정명", "건조해도 색과 형태가 유지되어 드라이플라워로 가장 인기 있는 꽃이다.", "정원, 화단, 온실", "없음"},
            {"산수유",     "Cornus officinalis",          "층층나무과",   "층층나무목",   "cornelian cherry",  "정명", "이른 봄 잎보다 먼저 노란색 작은 꽃이 나무를 뒤덮는다. 가을에 빨간 열매가 열리며 한약재로 쓰인다.", "산기슭, 정원, 공원", "없음"},
            {"소나무",     "Pinus densiflora",            "소나무과",     "소나무목",     "Korean red pine",   "정명", "한국을 대표하는 상록 침엽수로, 곧은 줄기와 붉은 수피가 특징이다. 솔방울과 잣은 식용된다.", "산지, 능선, 정원", "없음"},
            {"단풍나무",   "Acer palmatum",               "단풍나무과",   "무환자나무목", "Japanese maple",    "정명", "가을에 빨갛게 물드는 잎이 장관인 낙엽교목이다. 손바닥 모양의 잎이 특징적이다.", "산지, 정원, 공원", "없음"},
            {"대나무",     "Phyllostachys bambusoides",   "벼과",         "벼목",         "bamboo",            "정명", "빠르게 자라는 상록 풀로, 줄기는 건축자재와 공예품에 사용된다. 사군자 중 하나이다.", "산기슭, 정원, 대밭", "없음"},
            {"소철",       "Cycas revoluta",              "소철과",       "소철목",       "sago palm",         "정명", "열대 분위기를 내는 상록 식물로 깃털 같은 잎이 방사형으로 퍼진다. 살아있는 화석 식물이다.", "남부지방, 온실, 정원", "있음 (씨앗에 사이카신 함유, 간 독성)"},
            {"아카시아",   "Robinia pseudoacacia",        "콩과",         "콩목",         "black locust",      "정명", "5월에 흰색 꽃이 향기롭게 피며, 아카시아 꿀의 원료가 된다. 실제로는 아까시나무이다.", "산야, 길가, 공원", "있음 (수피·잎·씨앗에 로비닌 함유)"},
        };
